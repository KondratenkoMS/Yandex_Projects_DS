...
|[Определение возраста покупателей](https://github.com/KondratenkoMS/Yandex_Projects_DS/blob/main/Компьютерное%20зрение/Компьютерное%20зрение.ipynb)|Постройте модель, которая по фотографии определит приблизительный возраст человека.|tensorflow, keras, matplotlib|
